...
> **Amendement du 16 septembre 2026 — la rubrique visée prend l'accent.** Le
> survol d'une entrée de menu atténuait déjà les autres (§3.4 R7), mais laissait
> la visée à la couleur du texte : rien ne la désignait, elle était seulement la
> dernière à s'éteindre. Elle passe désormais à `--kn-surface-accent`, vert forêt
> sur fond clair, ivoire sur le vert et au-dessus de la vidéo, où le vert serait
...
- **Ligne de catégories et fil de la fiche** (amendement du 15 septembre 2026) : sur une catégorie comme sur la liste complète d'un univers, une ligne « Tout · Leggings · Shorts · T-shirts · Brassières » passe sous l'en-tête, à l'échelle d'étiquette. Sur téléphone, elle défile en largeur plutôt que de passer à la ligne, et la catégorie courante est ramenée dans le champ. La page courante reprend la couleur du texte et un filet de 1 px. Sur la fiche produit, le fil d'Ariane s'arrête à la catégorie de la pièce, en lien : « Accueil / Femme / Brassières », comme l'exemple du paragraphe suivant le prévoyait déjà. Le nom de la pièce est le titre juste en dessous.
- **Texte de rayon** (amendement du 16 septembre 2026, demande client) : une catégorie est une adresse filtrée par tag, donc une page sans description ni image dans Shopify. Un bloc « Texte de rayon » de la section collection lui en donne un, réglé par tag et par univers, posé entre l'en-tête et la barre d'outils, à la largeur de lecture de la phrase de contexte. Le récit des T-shirts Unisexe — KI, NŪ, le fil conducteur de cette énergie — y vit désormais, au lieu d'occuper le haut de deux fiches produit, où il se lisait comme une description de pièce.
...
- **Guide des tailles** (amendement du 16 septembre 2026) : le panneau de mensurations s'ouvre par un lien posé contre l'étiquette `TAILLE`, au moment où la question se pose. Il lit d'abord le métachamp de la pièce ; à défaut, le tableau commun réglé dans l'éditeur, une ligne par taille, colonnes séparées par une barre verticale. Une maison qui n'a qu'une grille de mensurations la saisit une fois pour tout le catalogue ; une pièce qui sort du lot garde son propre tableau. Sans l'un ni l'autre, ni lien ni panneau : mieux vaut pas de guide qu'un guide vide.
